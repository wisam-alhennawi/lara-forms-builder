...
[<img src="https://github-ads.s3.eu-central-1.amazonaws.com/lara-forms-builder.jpg?t=1" width="419px" />](https://spatie.be/github-ad-click/lara-forms-builder)
...
```bash
php artisan vendor:publish --tag="lara-forms-builder-migrations"
php artisan migrate
```
